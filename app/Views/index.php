  ...
  <nav class="navbar navbar-expand-lg sticky-top">
    <div class="container">
      <a class="navbar-brand d-flex align-items-center" href="#">
        ...
        <?php else: ?>
          <img src="<?= base_url('uploads/logo/espata.png') ?>" alt="ESPATA" style="height:36px; width:auto;">
        <?php endif; ?>
      </a>
  ...
  <footer class="footer">
    <div class="container">
      <div class="row g-5">
        <div class="col-lg-4">
          <a href="#" class="footer-logo">
            <?php if (!empty($school['logo'])): ?>
              <img src="<?= base_url('uploads/logo/' . $school['logo']) ?>" alt="Logo" style="height:40px; width:auto;">
            <?php else: ?>
              <img src="<?= base_url('uploads/logo/espata.png') ?>" alt="ESPATA" style="height:36px; width:auto; filter:brightness(0) invert(1);">
            <?php endif; ?>
          </a>
      ...
      <div class="text-center footer-text-muted small mt-4">
        &copy;
        <?= date('Y') ?>
        <?= esc($school['name'] ?? 'ESPATA') ?>. All rights reserved. School Management Platform. by <a href="https://sakasalika.com">SakaSalika</a>
      </div>
    </div>
  </footer>
