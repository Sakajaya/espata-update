...
class Quiz extends BaseController
{
    ...
    public function create()
    {
        ...
        // Prefill sub materi bila datang dari halaman materi (?material_id=)
        // Catatan: JANGAN mengisi $quiz agar view tetap mode "create" (bukan edit).
        $prefillMaterialId = (int) ($this->request->getGet('material_id') ?? 0);
